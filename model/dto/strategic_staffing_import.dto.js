module.exports = {
    ...
    fields: ['id', 'system_code', 'position_id', 'strategy', 'start_date', 'end_date', 'is_active', 'created_time', 'created_by', 'updated_time', 'updated_by'],
    update_key: ['id'],
    import_field: [],
    mapping: [
        {index: 1, field: 'stt', required: false},
        {index: 2, field: 'system_code', required: false},
        {index: 3, field: 'unit_0', required: false},
        ...
        {index: 11, field: 'strategy', required: true},
        {index: 12, field: 'totalEmp', required: false},
        {index: 13, field: 'start_date_str', required: true},
        {index: 14, field: 'end_date_str', required: false}
    ],
    start_index: 9,
    result: {
        index: 15,
